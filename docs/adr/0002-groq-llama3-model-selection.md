...
- **Graceful Fallbacks**: If the Groq API experiences rate limits or network issues, the application degrades to a local keyword-based mock categorization without breaking user workflows.
