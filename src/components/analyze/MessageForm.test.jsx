...
describe('MessageForm', () => {
  it('shows the character count for the current message', () => {
    render(<MessageForm message="hello" onMessageChange={() => {}} onAnalyze={() => {}} onClear={() => {}} isLoading={false} />)
  ...
  it('calls onMessageChange as the user types', async () => {
    ...
    render(<MessageForm message="" onMessageChange={onMessageChange} onAnalyze={() => {}} onClear={() => {}} isLoading={false} />)
  ...
  it('calls onAnalyze when the Analyze button is clicked', async () => {
    ...
    render(<MessageForm message="hi" onMessageChange={() => {}} onAnalyze={onAnalyze} onClear={() => {}} isLoading={false} />)
  ...
  it('calls onClear when the Clear button is clicked', async () => {
    const user = userEvent.setup()
    const onClear = vi.fn()
    render(<MessageForm message="hi" onMessageChange={() => {}} onAnalyze={() => {}} onClear={onClear} isLoading={false} />)
  ...
  it('disables inputs and shows a spinner while loading', () => {
    render(<MessageForm message="hi" onMessageChange={() => {}} onAnalyze={() => {}} onClear={() => {}} isLoading={true} />)
